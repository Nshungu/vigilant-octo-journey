    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-gray-600">
          Or
          <RouterLink to="/register" class="font-medium text-kigali-blue hover:text-blue-700">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                <a href="#" class="font-medium text-kigali-blue hover:text-blue-700">
        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-kigali-light text-gray-500">Or continue with</span>
            </div>
          </div>
